...
// add constructor
 ...
 // to connect the details page to the recycler view
        ((ViewHolder) holder).view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(fContext,Macros.class);
                i.putExtra("food",fArray.get(position));   // to transfer data through intent
                fContext.startActivity(i); // we use fContext again because we are working in an ADAPTER
            }
        });
